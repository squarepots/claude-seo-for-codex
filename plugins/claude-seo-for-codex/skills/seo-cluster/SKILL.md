...
---
<!-- CODEX-ADAPTER:BEGIN -->
> **Codex adapter.** Invoke this installed specialist as `$seo-cluster`; use `$seo <command> <target>`
...
### Check for a compatible blog-authoring Skill

```
Test: Is a compatible blog-authoring Skill discoverable in the current Codex task?
```

**If a compatible blog-authoring Skill is available:**
...
**If no compatible blog-authoring Skill is available:**
